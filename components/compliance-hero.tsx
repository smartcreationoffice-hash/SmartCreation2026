...
const pillars: Pillar[] = [
  { id: "trademark", index: "01", label: "Trademark", desc: "UAE & international filing", icon: Copyright },
  { id: "aml-esr-ubo", index: "02", label: "AML / ESR / UBO", desc: "Frameworks and filings", icon: BadgeCheck },
  { id: "attestation", index: "03", label: "Attestation", desc: "MOFA, notarisation, embassy", icon: FileSignature },
  { id: "renewal", index: "04", label: "License renewal", desc: "Annual renewals across zones", icon: RefreshCw },
];

const trust = [
  { value: "7+", label: "Years compliance work", meta: "Founded 2020" },
