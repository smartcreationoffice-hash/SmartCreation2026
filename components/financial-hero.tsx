...
const pillars: Pillar[] = [
  ...
  { id: "accounting", index: "02", label: "Accounting & VAT", desc: "Monthly books, VAT filing", icon: Calculator },
  { id: "corporate-tax", index: "03", label: "Corporate tax", desc: "Registration, returns, advisory", icon: FileText },
  { id: "audit", index: "04", label: "Audit", desc: "Statutory, internal, due diligence", icon: FileSearch },
];
